    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/", "/http://localhost:8081/login/oauth2/code/google","/deleteproduct", "/viewproducts","/cart", "/register","/save","/auth/login","/userCart","/AdminProduct","/admin_add","/products", "/css/**", "/js/**","/re-to").permitAll()
